...
module.exports = function(options) {
  ...
  if (options.prod) {
    ...
    plugins = [// Plugins for Webpack
      ...
      new ExtractTextPlugin("css/main.[chunkhash].css"),
      new webpack.DefinePlugin({
        "process.env": {
          NODE_ENV: JSON.stringify("production"),
          BASE_URL: JSON.stringify("https://sherlockhomes.world/"),
          GA_TRACKING_ID: JSON.stringify("UA-75211354-1")
        }
      })
    ];
    ...
    plugins = [
      ...
      new webpack.DefinePlugin({
        "process.env": {
          ...
          BASE_URL: JSON.stringify("http://localhost:9393/"),
          GA_TRACKING_ID: JSON.stringify("UA-75211354-2")
        }
      })
    ]
  }
